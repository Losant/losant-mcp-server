...
Applies one of 23 operations to an array on the workflow payload — filter, sort, search, slice, push/pop, group, and more. Up to 15 operations can be chained in a single node's `rules` array.
