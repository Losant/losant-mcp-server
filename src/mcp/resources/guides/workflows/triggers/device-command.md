...
- After executing a command, publish a message on a custom MQTT topic using an MQTT node. Listen for it in a cloud workflow with an MQTT Trigger to confirm receipt.
