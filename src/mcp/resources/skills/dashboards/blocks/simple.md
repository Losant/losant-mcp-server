...
For the block object shape (`id`, `blockType`, `title`, `startX/Y/width/height`, `applicationId`) see `SKILL.md`. Only the `config` and any block-specific notes are documented here.
