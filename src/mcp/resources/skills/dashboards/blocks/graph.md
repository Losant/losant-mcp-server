...
- `applicationId` is required on org / sandbox dashboards, omitted on application-owned dashboards. See `SKILL.md`.
- Standard layout fields apply — see `SKILL.md`. A typical width is `4` (full row); typical height is `1.5`–`3` units.
